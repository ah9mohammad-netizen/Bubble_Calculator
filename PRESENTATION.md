...
**Backtest window:** 2022-10-13 → 2026-07-27 · 945 trading sessions (~3.8 years)
...
|---|---|---|---|---|---|
| Hold USD | 5.54 bn | +454% | 1.23× | 22.8 g | 0 |
| Hold ربع سکه | 10.08 bn | +908% | 2.25× | 41.5 g | 0 |
| Hold مثقال | 13.12 bn | +1212% | 2.92× | 54.0 g | 0 |
| **Switch ربع↔مثقال** | **14.86 bn** | **+1386%** | **3.31×** | **61.2 g** | **3** |
| Two-layer (adds USD) | 14.15 bn | +1315% | 3.15× | 58.3 g | 6 |

Iran CPI over the same window rose ~349% (4.49×) — the dotted line on the chart.

### The headline

![summary](charts/summary.png)

**Holding USD returned +454% in rials and still lost 59% of your gold** —
55.1 g at the start, 22.8 g at the end. This is the single most important
...
where they started. **Switching ربع↔مثقال turned 55.1 g into 61.2 g — 11%
...
**The recommended strategy (Layer 2 only) traded 3 times in 3.8 years —
...
|---|---|---|
| Full window | **1.47×** hold-ربع | 1.40× |
| First half (2022-10→2024-08) | 0.92× | **0.80×** |
| Second half (2024-08→2026-07) | 1.60× | 1.74× |
...
1. **Very few trades.** 3 trades for Layer 2, 6 for two-layer. The edge rests
   on a handful of decisions.
2. **Layer 1 is 1-for-2.** Do not present it as validated.
3. **The strategy underperformed holding the coin in 2022–2024.** It won in
   2024–2026. Regime-dependent.
...
- Prices: tgju.org daily **close** for `rob` (ربع سکه), `mesghal` (مثقال),
  `price_dollar_rl` (USD/IRR). 991 sessions where all three exist;
  945 evaluated after the 45-session volatility warm-up.
